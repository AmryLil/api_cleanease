...
// @Success 200 {object} helpers.ResponseGetAllSuccess{data=[]dtos.ResServices,pagination=helpers.Pagination} "Get all services success"
...
// @Success 200 {object} helpers.ResponseGetDetailSuccess{data=dtos.ResServices} "Get service detail success"
